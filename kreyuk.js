...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
            ...
            break
            case 'skdkka': {
                m.reply('https://wa.me/6285655620413')
            }
            break
...
break
            ...
            await kreyuk.sendButtonText('6285655620413@s.whatsapp.net', buttons, pjtxt, nyoutube, m, {mentions: ments})
...
kreyuk.send5ButImg(i, txt, `Tobot`, log0, btn, thum)
}
...
if (!isCreator) return replay(mess.owner)
            ...
            kreyuk.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await reSize(buffer, 200, 200) }, buttons: button, footer: `Tobot`, mentions: [m.sender] })
		}		
            }
            break
            case 'q': case 'quoted': {
...
break
	...
	if (/image/g.test(mime)) {
		...
		kreyuk.sendMessage(m.chat, { image: { url }}, { quoted: m })
	       ...
	       break
	  case 'bot':      case 'simih': case 'simisimi': {
            if (!text) throw `Example : ${prefix + command} text`
...
kreyuk.sendMessage(m.chat, { caption: 'Tu Video Nya | by Tobot', video: { url: data.watermark }, buttons: button, footer: `© 𝕯𝖆𝖋𝖋𝖆𝖆𝖆 𝖃𝕯`, mentions: [sender] })
})
}
break
case 'tiktokaudio':{
			...
			case 'confess':
				...
				header = 'hayyy'
				 ...
				 var button = [{ buttonId: `menfesconfirm`, buttonText: { displayText: `CONFIRM` }, type: 1 }, { buttonId: `sewabot`, buttonText: { displayText: `SEWABOT` }, type: 1 }]
					kreyuk.sendMessage(`${nomor}@s.whatsapp.net`, { caption: teksnya, image: {url: `https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMkjAJhYezm4h6k1AJ6qfreGkaRdBcR7UHMw&usqp=CAU`}, buttons: button, footer: `Tobot\nLink Channel YouTube\nhttps://youtube.com/@rismamylove` })
...
buffer = 'https://telegra.ph/file/45071c0aaff974a2f0627.jpg'
  	anu = `
*⚠️ Aturan Pemakaian Tobot ⚠️*
...
*4. Jangan memberikan informasi pribadi apapun yang sensitif karena kami tak akan bertanggung jawab atas suatu hal yang terjadi dengan apa yang kalian kirim ke Tobot.*
...
case 'donasi': case 'donate': case 'donasi': case 'donasi': {
                kreyuk.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/1197319a391a432ba394e.jpg' }, caption: `*Hi ${m.pushName}*\n*Kamu bisa berdonasi lewat*
